        ...
        <>
            <section className="min-h-screen bg-[#101b27] text-[#E8E8E8] py-12 lg:px-32 lg:py-20 lg:space-y-10 flex flex-col items-center">
                <div className='space-y-10 mb-10'>
                    ...
                    <div className="mx-auto text-center space-y-8 w-screen">
                        <h1 className="text-3xl lg:text-5xl font-bold text-[#D9D9D9]">
                            Advogados especialistas em BPC/LOAS
                        </h1>

                        <div className="bg-[#D9D9D9] flex justify-center py-6 shadow-md w-screen">
                ...
                <div className="max-w-4xl mx-auto bg-[#D9D9D9] text-[#101b27] shadow-xl p-8 space-y-6">
                ...
                <div className="max-w-4xl mx-auto bg-[#D9D9D9] text-[#101b27] p-8 space-y-6">
