...
export default function HomeSection() {
    return (
        <section className="h-screen bg-gradient-to-r from-background via-gradient" id="home">
            ...
            <section className="h-[50%] bg-foreground flex flex-col items-center gap-2 text-center justify-center">
                <h1 className="text-6xl text-[#174472] uppercase">Bem-vindo</h1>
