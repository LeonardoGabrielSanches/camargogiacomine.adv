                    ...
                    {data?.articles
                        ...
                        .map((article, index) => (
                            <Link
                                ...
                                className="flex flex-col items-center text-center gap-4 w-full sm:w-[48%] lg:w-[30%] bg-[#d9d9d9] border border-[#d9d9d9] rounded-lg p-6 hover:scale-105 hover:shadow-lg transition-transform duration-300 cursor-pointer lg:flex"
                            >
                                <img
                    ...
                    {data?.articles
                        ...
                        .map((article, index) => (
                            <Link
                                key={index}
                                to={`/artigo/${article.slug}`}
                                className="hidden lg:flex flex-col items-center text-center gap-4 w-full sm:w-[48%] lg:w-[30%] bg-[#d9d9d9] border border-[#d9d9d9] rounded-lg p-6 hover:scale-105 hover:shadow-lg transition-transform duration-300 cursor-pointer"
                            >
                                <img
                                    src={article.imagem.url}
                                    alt={article.titulo}
